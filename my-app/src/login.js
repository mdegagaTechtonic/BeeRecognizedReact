              ...
              <div className="img text-center">
                <img id="img" src="images/bee.png" width="50"/>
                            <div class="text-center my-5">
                              <a href=""><img onClick={this.props.action} src="https://platform.slack-edge.com/img/sign_in_with_slack.png" srcset="https://platform.slack-edge.com/img/sign_in_with_slack.png 1x, https://platform.slack-edge.com/img/sign_in_with_slack@2x.png 2x" id ="slack"/></a>
                            </div>
